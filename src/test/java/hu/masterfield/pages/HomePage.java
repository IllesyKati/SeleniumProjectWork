...
@Feature("Az oldalon található elemek azonosítása. Ezek szükségesek a HomePagerõl induló\n" +
        "        mûveletekhez.")

public class HomePage extends BasePage{

    /*  Az oldalon található elemek azonosítása. Ezek szükségesek a HomePagerõl induló
        mûveletekhez.
     */
...
//    @FindBy(css="a.nav-link[href=\"/bank/user/logout\"]")
    ...
    /**
     * A HomePagerõl elnavigál a Create Savings oldalra a menüben.
     *
    ...
    /**
     * HomePagerõl elnavigál a View Savings oldalra.
     *
    ...
    /**
     * HomePagerõl elnavigálunk a Deposit oldalra.
     *
    ...
    /**
     * HomePagerõl elnavigálunk a Savings/Transactions oldalra.
     *
    ...
    /**
     * HomePagerõl elnavigálunk a MyProfile oldalra.
     *
     * @return MyProfile oldal objektuma
     */
    @Step("Navigálás a profil adatokat megjelenítõ és módosító oldalra.")
    ...
    /**
     * Ellenõrzi a HomePage betöltõdését
     *
     * @return true, ha betöltõdött a HomePage
     */
    @Step("HomePage betöltõdésének ellenõrzése.")
    ...
    /**
     * HomePage ellenõrzése.
     */
    @Step("HomePage ellenõrzése.")
    ...
    /**
     * HomePage ellenõrzése profil módosítása után.
     */
    @Step("HomePage ellenõrzése profil mósosítása után.")
