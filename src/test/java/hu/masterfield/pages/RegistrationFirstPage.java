...
/**
 * Regisztráciõs form elsõ oldalának osztálya
 *
 */
...
public class RegistrationFirstPage extends BasePage{
    ...
    /** Ellenõrizzük, hogy megjelentek-e az oldalon az adott elemek.
     *
     * @return true , ha az oldal betöltõdött, megjelentek az elvárt elemek és
     * kattinthatóak
     */
    @Step("Regisztrációs oldal betöltésének ellenõrzése")
