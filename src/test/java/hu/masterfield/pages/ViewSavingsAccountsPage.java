 ...
 * Saving típusok visszaellenõrzése létrehozás után
 */

@Feature("Megtakarítás típusú accountok megtekintése/ellenõrzése")
public class ViewSavingsAccountsPage extends BasePage{
    ...
    /**
     * Megjelenõ Savingek ellenõrzése
     */
    @Step("Megjelenõ Savingek ellenõrzése")
     ...
     */
    @Step("A felületen lévõ összes Saving átalakítása Java objektummá")
...
//                    .getText();
     ...
     */
    @Step("ViewSavingsAccounts oldal betöltésének ellenõrzése")
