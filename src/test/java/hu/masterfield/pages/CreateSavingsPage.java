...
/**
 * Megtakarítás típusú accountok létrehozásáért felelõs osztály
 */

@Feature("Megtakarítás típusú accountok létrehozásáért felelõs osztály")
public class CreateSavingsPage extends BasePage{
    ...
    public ViewSavingsAccountsPage createNewSaving(Saving saving) {
        ...
        if (saving.getAccountTypes().equals(Consts.ACCOUNT_TYPES_SAVINGS)) {
            // RadioButton esetében ez az ellenõrzés nem szükséges.
