...
@Feature("Bejelentkezési képernyõ kezeleése")
public class LoginPage extends BasePage {
    ...
    private WebElement logoutCompletedMessage;  // sikeres kijelentkezésrõl tájékoztatás
    ...
    /**
     * Ellenõrzi, hogy megjelentek-e az oldalon a megadott elemek.
     *
     * @return true az oldal betöltõdött, megjelentek az elemek és kattinthatóak
     */
    @Step("Login oldal betöltésének ellenõrzése")
    ...
    /**
     * Ellenõrzi, hogy a sikeres regisztráció után megjelent-e az oldalon a megadott elem.
     *
     * @return trua az oldalon megjelent az elvárt szöveg
     */
    @Step("Regisztráció sikerességének ellenõrzése")
