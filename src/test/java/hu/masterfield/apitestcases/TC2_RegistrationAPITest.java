...
public class TC2_RegistrationAPITest extends BaseAPITest{
     ...
     * megadott adatokkal, ellenõrzi a profil létrejöttét.
     *
     * POST /api/v1/user
     *
     * createNewUser
    ...
    public void testCreateNewUser() {
        ...
        /* A globalTestData.properties fileból kiolvasott email címet ellenõrizzük, amivel regisztráltunk.
         */
        ...
        /* Ellenõrizzük, hogy a válaszban helyesek-e a regisztrációs adatok */
